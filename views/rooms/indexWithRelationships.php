...
use yii\helpers\Url;
?>
<h1>Sau khi đã loại bỏ những gì không thể xảy ra thì cái còn lại, dù vô lý đến đâu, cũng vẫn là sự thật</h1>
<br>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <table class="table">
            ...
            <tr>
                <td><a class="btn btn-primary btn-xs" href="<?php echo Url::to(['index-
with-relationships', 'customer_id' => $customer->id]) ?>">detail</a></td>
